...
function Home(prop) {
  return (
    <div>
        <main className='bg-black h-35 md:h-96 bg-no-repeat bg-contain md:bg-right bg-bottom overflow-hidden relative text-white flex pt-10 md:py-10'
            ...
            <div className=' w-80 mx-auto flex flex-col md:w-85  md:flex-row gap-3'>
                <div className=' self-center  md:w-50'>
                  ...
                  <Button onclick={prop.onclick} children='Donate' bgColor='bg-orange-500' bdRad='rounded-[1.2rem]' />
                </div>
              </div>
        </main>
